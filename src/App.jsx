  ...
  return (
    <div className="min-h-screen h-[200vh] bg-gray-950 ">
      ...
      <div className="w-full h-170 ">
        ...
        {/* right content */}
        {/* <div className="place-items-end md:w-100%">
      ...
      <div className="flex flex-col items-center justify-center mb-30 bg-gray-950 p-10 rounded-lg shadow-lg animate__animated animate__fadeInLeft animate__delay-1s">
        <h1 className="text-4xl font-bold mb-5 bg-gradient-to-r from-red-600 to-indigo-800 bg-clip-text hover:text-rose-900 transition-all duration-500 ease-in-out delay-200 text-transparent ml-2">Belum tau mau Buat apa di sini</h1>
      </div>
